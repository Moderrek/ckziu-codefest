...
export default function Navbar() {
  return (
    <div className='navbar flex-no-wrap border-gradient-to-r sticky top-0 z-50 border-b-2 bg-white dark:bg-opacity-0 bg-opacity-30 from-indigo-500	 backdrop-blur-2xl'>
